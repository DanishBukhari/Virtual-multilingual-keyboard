//when you will making a page all you have to do is to name that language using a anchor tag and in href paste the name of that language" like in case of azerbyjan paste it in the href of anchor tag    "this.VKI_layout['\u0410\u0437\u04d9\u0440\u0431\u0430\u0458\u04b9\u0430\u043d\u04b9\u0430']". then when someone will click that link he will redirect to that language keyboard. that's it. You have to do it for all the other languages.
...
//here VKI stands for virtual keyboard input
...
(function () {
  ...
  VKI_attach = function (elem) {
    ...
    if (self.VKI_imageURI) {
      ...
      elem.parentNode.insertBefore(
        keybut,
        elem.dir == "rtl" ? elem : elem.nextSibling
      );
    } else {
            ...
            VKI_addListener(
              ...
              function () {
                ...
                if (
                  ...
                  self.VKI_target.createTextRange &&
                  !self.VKI_target.readOnly
                ) {
                  try {
  ...
  this.VKI_modify = function (type) {
    ...
    var tables = this.VKI_keyboard.tBodies[0]
          ...
          default:
            if (type) {
              ...
              if (this.VKI_symbol[lkey[vchar]]) {
                ...
                tds[y].appendChild(
                  document.createTextNode(lkey[vchar] || "\xa0")
                );
            }
            if (this.VKI_deadkeysOn.checked) {
              var character =
  ...
  this.VKI_show = function (elem) {
    if (!this.VKI_target) {
      ...
      this.VKI_target.keyboardPosition = "static";
      do {
    ...
    if (self.VKI_target) {
      ...
      if (place || force === true) {
        ...
        while ((scr = scr.parentNode)) {
          ...
          if (
            scr.scrollHeight > scr.offsetHeight ||
        ...
        self.VKI_keyboard.style.left =
          Math.max(
            10,
            Math.min(wDim[0] - self.VKI_keyboard.offsetWidth - 25, iPos[0])
          ) + "px";
        if (self.VKI_isIE6) {
